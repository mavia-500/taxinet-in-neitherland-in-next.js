        ...
        <div>
            <div className='flex justify-around  p-20 mt-30'>
                ...
                <div className='grid grid-cols-4'>
                    <img src="/aset/images/Group 331.png" alt="" />
                    <img src="/aset/images/Group 335.png" alt="" />
                    <img src="/aset/images/image 3.png" alt="" />
                    <img src="/aset/images/Group 331 (1).png" alt="" />
                    <img src="/aset/images/image.png" alt="" />
                    <img src="/aset/images/Group 332 (1).png" alt="" />
                    <img src="/aset/images/Group 332 (1).png" alt="" />
                    <img src="/aset/images/Group 332 (2).png" alt="" />
            ...
            <div className='flex p-10 justify-around items-center  w-full   '>
                <div className=' bg-[#2d2d2d] grid grid-cols-2  rounded-lg w-3/5 h-80'>
                    <div>
                        <img src="/aset/images/Group 1000001780.png" alt="" />
                    </div>
            ...
            <div className='grid grid-cols-3  gap-13 p-20 '>
                <div className='border-2 border-[#ff8900] w-[90%]'>
                    <img src="/aset/images/Rectangle 47.png" alt="" className='' />
                    <div className=' m-5'>
                ...
                <div className='border-2 border-[#ff8900] w-[90%]'>
                    <img src="/aset/images/Rectangle 47 (1).png" alt="" />

                    <div className=' m-5'>
                        <h3 className='font-bold'>Vliegveld Taxi</h3>
                        <p className='mt-5'>Taxinet is ook uw aanspreekpunt voor luchthavenvervoer met zéér scherpe prijzen. Wij brengen u naar elk gewenst vliegveld.</p>

                    </div>
                </div>

                <div className='border-2 border-[#ff8900] w-[90%]'>
                    <img src="/aset/images/Rectangle 47 (2).png" alt="" />
                ...
                <div className="md:w-[40%] md:pl-10 space-y-5 mt-15 p-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div className="flex items-start space-x-3 mt-8">
                            <img src="/aset/images/24-hours-support (1) 1 1.png" alt="" className="text-orange-500 text-2xl w-10 h-10" />
                        ...
                        <div className="flex items-start space-x-3 mt-8">
                            <img src="/aset/images/24-hours-support (1) 1 1 (1).png" alt="" className="text-orange-500 text-2xl w-10 h-10" />
                        ...
                        <div className="flex items-start space-x-3 mt-8">
                            <img src="/aset/images/24-hours-support (1) 1 1 (2).png" alt="" className="text-orange-500 text-2xl w-10 h-10" />
                            <p className="text-gray-800 text-sm">
                        ...
                        <div className="flex items-start space-x-3 mt-8">
                            <img src="/aset/images/24-hours-support (1) 1 1 (3).png" alt="" className="text-orange-500 text-2xl w-10 h-10" />
                            <p className="text-gray-800 text-sm">
                        ...
                        <div className="flex items-start space-x-3 mt-8">
                            <img src="/aset/images/24-hours-support (1) 1 1 (4).png" alt="" className="text-orange-500 text-2xl w-10 h-10" />
                            <p className="text-gray-800 text-sm">
