...
const ParticulierreserveringsformulierForm = () => {
  return (
     <div className="min-h-screen w-full bg-black text-white flex justify-center py-14 px-4">
        <div className="w-full max-w-4xl border border-orange-500 rounded-xl p-10 space-y-12">
          <h2 className="text-2xl font-semibold text-center">
            Gegevens Klant (particulier)
          </h2>
...
export default ParticulierreserveringsformulierForm